...
/**
 * Success message sent from Worker to Manager
 * Example JSON:
 * {
 ...
 * }
 */
public class WorkerResponseMessage {
    ...
    public WorkerResponseMessage() {
    }
    
    public WorkerResponseMessage(String type, ResponseData data) {
        this.type = type;
        this.data = data;
    }
    ...
    public static class ResponseData {
        ...
        public ResponseData(String fileUrl, String outputUrl, String parsingMethod) {
