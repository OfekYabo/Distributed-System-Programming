...
public class Ec2Service implements AutoCloseable {
    ...
    private String createManagerUserDataScript() {
        ...
        // It installs Java, downloads manager.jar from S3, and runs it
        return "#!/bin/bash\n" +
               "set -e\n" +
               ...
               "export LOCAL_APP_INPUT_QUEUE=" + config.getLocalAppInputQueue() + "\n" +
               "export LOCAL_APP_OUTPUT_QUEUE=" + config.getLocalAppOutputQueue() + "\n" +
               "# Run the Manager\n" +
